...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/teamLider").hasAnyAuthority("TEAM_LIDER")
                .antMatchers("/users").hasAnyAuthority("TEAM_LIDER")
                .antMatchers("/projects").hasAnyAuthority("TEAM_LIDER")
                .antMatchers("/newProjectPage").hasAnyAuthority("TEAM_LIDER")
